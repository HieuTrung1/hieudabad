...
game.StarterGui:SetCore("SendNotification", {
          ...
          wait()
                ...
                local win = Flux:Window("hieu dz", "tuan ngu lon", Color3.fromRGB(0,166,58), Enum.KeyCode.F2)
...
game:GetService("Players").LocalPlayer.PlayerGui.Menu.Frame.C.Frame.Nametag.Text = "HIEU TRUM"
game:GetService("Players").LocalPlayer.PlayerGui.Menu.Frame.C.Frame.Header.Text = "SKIDDER"
end)
    ...
    game:GetService("Workspace").UserData["User_"..Final].Data.Gems.Value = 0
    ...
    game:GetService("Workspace").UserData["User_"..Final].HakiBar.Value = 0
        ...
        page1:Textbox("Fake Haki", "", true, function(Value)
            game:GetService("Players").LocalPlayer.PlayerGui.Menu.Frame.C.Frame.Haki.Text = "Haki: "..Value
                ...
                page1:Textbox("Gems", "", true, function(Value)
...
wait(2)
    ...
    hakitarget = 50
    page2:Slider("Haki Target %",  1, 100,50,function(gmm)
    hakitarget = gmm
    end)
        hakispeed = 7
    page2:Slider("Haki Speed",  1, 20,7,function(gttmm)
    hakispeed = gttmm
    end)
...
affpoint = 10
affty = 2
page4:Slider("Affinities Point", 1, 10, 10,function(treo)
affpoint = treo
